...
trace_files = []
for folders in [
    r"logs\spb\Flat32\Medium\RandomBuild\Qwen2.5-32B-Instruct\*\trace.json",
    r"logs\spb\Flat32\Easy\Rush\Qwen2.5-32B-Instruct\*\trace.json",
    r"logs\spb\Flat32\Medium\Rush\Qwen2.5-32B-Instruct\*\trace.json",
    # r"logs\spb\Flat32\Medium\RandomBuild\Qwen2.5-32B-Instruct-SFT\2025-06-08-09-49-18\trace.json",
]:
...
for trace_file in tqdm(trace_files):
    ...
    trace_data = list(trace_data.values())[:-1]
...
with open("sc2-0611.json", "w", encoding="utf-8") as f:
